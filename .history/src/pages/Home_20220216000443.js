                ...
                <div className="row top_image">
                    <div className="col-6 text-left  my-auto">
                       ...
                       <div className="col-12 set_col">
                        ...
                        <p className="font_set">Lorem ipsum dolor sit amet,<br /> consectetur adipiscing elit. <br />Cras congue dolor ex, non<br /> molestie lacus interdum <br />tincidunt. Aliquam quis<br /> iaculis metus, nec <br />consectetur tellus. Proin eu est tortor. Sed erat nibh, pretium id magna faucibus, varius faucibus felis. Morbi id urna ut ex tristique maximus et id odio. Morbi laorevet erat et nuncv lobortis, sit amet luctus turpis egestas. Duis cursus metus purus, ut maximus enim euismod vel. Mauris elementum, mauris ut ultrices interdum, libero velit facilisis diam, nec consectetur est mauris id purus.</p>
                        </div>
                        </div>
                    </div>
                    </div>
