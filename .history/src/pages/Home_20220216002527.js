 ...
 <section className="top_section">
            <div className="container">
                <div className="row top_image">
                    <div className="col-sm-12 col-md-4 col-lg-6 text-left  my-auto">
                       <div className="row">
                    ...
                    <div className="col-sm-12 col-md-7 col-lg-6 text-right second_content">
                    ...
                    <div className=" bg_btn text_e"><p>25 max / tx</p></div>
                    </div>
                    </div>
</div>
