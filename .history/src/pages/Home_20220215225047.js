 ...
 <section className="top_section">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-6 text-right top_content">
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-md-6 left_sec_col img_col">
                        ...
                        <div className="row pluss_minus_row">
                            <div className="col-2 text-center">
                                <img src="assets/images/minus.svg" alt="minus" className="desktop_image"/>
                            </div>
                            <div className="col-8 text-center">
                                <img src="assets/images/KONGZ2237.png" alt="KONGZ2237" className="desktop_image"/>
                                <img src="assets/images/KONGZ2237.png" alt="KONGZ2237" className="desktop_image"/>
                                <img src="assets/images/KONGZ2237.png" alt="KONGZ2237" className="desktop_image"/>
                            </div>
                            <div className="col-2 text-center">
                                <img src="assets/images/plus.svg" alt="pluss" className="desktop_image"/>
                            </div>
                            <div className="col-md-12 text-center ">
                                <a className="button">
                                    MINT 3 KONGZ
                                </a>
                                <p className="sol">[ 0.075 SOL ]</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 right_sec_col">
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas non eros cursus, convallis ligula tristique, malesuada purus. Vestibulum consectetur mollis tristique. Nunc gravida efficitur odio ut luctus. Praesent viverra lorem eu erat hendrerit, eget lacinia elit sagittis. Pellentesque accumsan ac mi eget semper.
                        </p> 
                    </div>
                </div>
            </div>
